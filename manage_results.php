...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="./images/juet.png" alt="" class="logo" style=" border-radius:50%; background-color: white;  width: 80px; height:80px"></a>
        <span class="heading">JUET Dashboard</span>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="DBMS">
                <input type="text" name="p2" id="" placeholder="OS">
                <input type="text" name="p3" id="" placeholder="CN">
                <input type="text" name="p4" id="" placeholder="SDLC">
                <input type="text" name="p5" id="" placeholder="TOC">
